...
class Config:
    ...
    PREPROCESSING_MODEL = os.getenv('PREPROCESSING_MODEL', 'denoiser_hifi')  # Default model for noise removal

    CORE_ASR_MODEL = os.getenv('CORE_ASR_MODEL', 'Citrinet-1024')  # Default model for Automatic Speech Recognition (ASR)
    CORE_DIARIZATION_MODEL = os.getenv('CORE_DIARIZATION_MODEL', 'speakerdiar_telephony')  # Default model for speaker diarization
